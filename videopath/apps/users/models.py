...
class UserProfile(models.Model):
    ...
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, default=GENDER_UNDISCLOSE)
    occupation = models.CharField(blank=True, max_length=64)
    industry = models.IntegerField(default=1, choices=INDUSTRY_CHOICES)
    industry_other = models.CharField(blank=True, max_length=64)
    birthdate = models.DateField(blank=True, null=True)

    avatar = models.ForeignKey(
        "files.ImageFile",
        related_name="avatar_thumbnail",
        blank=True,
        default=None,
        null=True,
    ...
    def __unicode__(self):
        return "Profile of " + self.user.__unicode__() 
    ...
    def save(self, *args, **kwargs):
        if not self.industry_other or self.industry != 999:
            self.industry_other = ""
...
class Team(VideopathBaseModel):
    ...
    name = models.CharField(max_length=150, default='My Videos')
    description = models.TextField(blank=True)
    cover = models.ForeignKey(
        "files.ImageFile",
        related_name="cover_thumbnail",
        blank=True,
        default=None,
        null=True,
        on_delete=models.SET_NULL
    ...
    # each user has a default team where his videos go
