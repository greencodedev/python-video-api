...
from videopath.apps.users.views import UserViewSet, TeamViewSet, TeamMemberViewSet, profile_view, profile_index
...
urlpatterns = patterns('',
    url(r'profile/$', profile_index), 
    url(r'profile/(?P<pid>\w+)/', profile_view),
