...
from .models import APIToken, UserCampaignData, UserSalesInfo, AuthenticationToken,UserActivityDay, OneTimeAuthenticationToken, UserActivity, AutomatedMail, UserSettings, UserProfile, User, Team, TeamMember
...
class TeamAdmin(admin.ModelAdmin):
    ...
    raw_id_fields = ['cover', 'owner', 'is_default_team_of_user']
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('__unicode__', 'first_name', 'last_name', 'gender', 'occupation', 'industry_summary')
    autocomplete_lookup_fields = {
        'fk': ['user',],
    }
